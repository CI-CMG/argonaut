...
public class NetCdfTiedArgoProfileV31Parameter implements ArgoProfileV31Parameter {
  ...
  public NetCdfTiedArgoProfileV31Parameter(NetCdfTiedArgoProfileV31 parent, String parameterName, int paramIndex) {
    ...
    try {
      qc = NetCdfUtils.getProfileString(netcdf, parent.getProfileIndex(), "PROFILE_" +parameterName + "_QC");
    } catch (IOException e) {
      throw new RuntimeException("Unable to initialize profile parameter data wrapper", e);
    }
  }
