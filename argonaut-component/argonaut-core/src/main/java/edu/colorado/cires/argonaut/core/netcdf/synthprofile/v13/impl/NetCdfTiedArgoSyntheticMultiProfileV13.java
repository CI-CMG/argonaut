...
public class NetCdfTiedArgoSyntheticMultiProfileV13 implements ArgoSyntheticMultiProfileV13 {
  ...
  public NetCdfTiedArgoSyntheticMultiProfileV13(NetcdfFile netcdf) {
    ...
    softwareVersion = NetCdfReadUtils.getGlobalAttributeString(netcdf, "software_version");
