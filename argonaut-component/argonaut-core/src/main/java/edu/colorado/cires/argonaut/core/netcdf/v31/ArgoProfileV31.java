...
//
//  List<List<String>> getCalibratedParameters(int profileIndex);
//
//  List<Map<String, String>> getScientificCalibrationEquation(int profileIndex);
//  List<Map<String, String>> getScientificCalibrationCoefficient(int profileIndex);
//  List<Map<String, String>> getScientificCalibrationComment(int profileIndex);
//  List<Map<String, Instant>> getScientificCalibrationDate(int profileIndex);
