...
class MergeProfile {
  ...
  private static final String dataType = "Argo profile    ";
  private static final String formatVersion = "3.1";
  private static final String handBookVersion = "1.2";
  private static final String referenceDateTime = "19500101000000";
  ...
  MergeProfile(Instant currentDateTime) {
    this.currentDateTime = currentDateTime;
  }

  static ArrayString getDataType() {
    return getArrayStringD1(new int[]{ProfileNcConsts.STRING16}, dataType);
  }

  static ArrayString getFormatVersion() {
    return getArrayStringD1(new int[]{ProfileNcConsts.STRING4}, formatVersion);
  }

  static ArrayString getHandBookVersion() {
    return getArrayStringD1(new int[]{ProfileNcConsts.STRING4}, handBookVersion);
  }

  ArrayString getReferenceDateTime() {
    return getArrayStringD1(new int[]{ProfileNcConsts.DATE_TIME}, referenceDateTime);
  }
  ...
  private void addScientifiCalibDates(Variable var) throws InvalidRangeException, IOException {
  ...
  private static ArrayFloat getArrayFloat(int shape0, int shape1, List<List<Float>> ncData) {
  ...
  private static ArrayString getArrayStringD1(int[] shape, String ncData) {
  ...
  private static ArrayString getArrayStringD2(int[] shape, List<String> ncData) {
    ArrayString data = new ArrayString(shape);
    Index ima = data.getIndex();
    for (int x = 0; x < shape[0]; x++) {
  ...
  private static ArrayString getArrayStringD4(int[] shape, List<List<List<String>>> ncData) {
