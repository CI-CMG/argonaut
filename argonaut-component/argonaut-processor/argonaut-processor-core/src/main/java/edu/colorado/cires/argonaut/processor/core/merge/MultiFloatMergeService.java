...
public final class MultiFloatMergeService {

  // https://docs.unidata.ucar.edu/netcdf-java/5.4/userguide/writing_netcdf.html

  //prevent instantiation
  private MultiFloatMergeService() {

  }

  public static void mergeFloats(Path outputFile, List<CoreProfile> coreProfiles, Instant currentDateTime) throws IOException {

    MergeProfile mergeProfile = new MergeProfile(currentDateTime);
    ...
    Variable.Builder VarHistoryInstitution = builder.addVariable(ProfileNcConsts.HISTORY_INSTITUTION, DataType.STRING,
            Arrays.asList(nHistoryDim, nProfDim, string4Dim))
        .addAttribute(new Attribute("long_name", "Institution which performed action"))
        .addAttribute(new Attribute("conventions", "Argo reference table 4"))
        .addAttribute(new Attribute("_FillValue", " "));

    Variable.Builder VarHistoryStep = builder.addVariable(ProfileNcConsts.HISTORY_STEP, DataType.STRING,
            Arrays.asList(nHistoryDim, nProfDim, string4Dim))
    ...
    Variable.Builder VarHistorySoftware = builder.addVariable(ProfileNcConsts.HISTORY_SOFTWARE, DataType.STRING,
            Arrays.asList(nHistoryDim, nProfDim, string4Dim))
    ...
    Variable.Builder VarHistorySoftwareRelease = builder.addVariable(ProfileNcConsts.HISTORY_SOFTWARE_RELEASE, DataType.STRING,
            Arrays.asList(nHistoryDim, nProfDim, string4Dim))
        .addAttribute(new Attribute("long_name", "Version/release of software which performed action"))
        .addAttribute(new Attribute("conventions", "Institution dependent"))
        .addAttribute(new Attribute("_FillValue", " "));

    Variable.Builder VarHistoryReference = builder.addVariable(ProfileNcConsts.HISTORY_REFERENCE, DataType.STRING,
            Arrays.asList(nHistoryDim, nProfDim, string64Dim))
        .addAttribute(new Attribute("long_name", "Reference of database"))
        .addAttribute(new Attribute("conventions", "Institution dependent"))
        .addAttribute(new Attribute("_FillValue", " "));

    Variable.Builder VarHistoryDate = builder.addVariable(ProfileNcConsts.HISTORY_DATE, DataType.STRING,
            Arrays.asList(nHistoryDim, nProfDim, dateTimeDim))
        .addAttribute(new Attribute("long_name", "history record was created"))
        .addAttribute(new Attribute("conventions", "YYYYMMDDHHMISS"))
        .addAttribute(new Attribute("_FillValue", " "));

    Variable.Builder VarHistoryAction = builder.addVariable(ProfileNcConsts.HISTORY_ACTION, DataType.STRING,
            Arrays.asList(nHistoryDim, nProfDim, string4Dim))
    ...
    Variable.Builder VarHistoryParameter = builder.addVariable(ProfileNcConsts.HISTORY_PARAMETER, DataType.STRING,
            Arrays.asList(nHistoryDim, nProfDim, string4Dim))
        .addAttribute(new Attribute("long_name", "Station parameter action is performed on"))
        .addAttribute(new Attribute("conventions", "Argo reference table 3"))
        .addAttribute(new Attribute("_FillValue", " "));

    Variable.Builder VarHistoryStartPres = builder.addVariable(ProfileNcConsts.HISTORY_START_PRES, DataType.FLOAT,
            Arrays.asList(nHistoryDim, nProfDim))
    ...
    Variable.Builder VarHistoryPreviousValue = builder.addVariable(ProfileNcConsts.HISTORY_PREVIOUS_VALUE, DataType.FLOAT,
            Arrays.asList(nHistoryDim, nProfDim))
        .addAttribute(new Attribute("long_name", "Parameter/Flag previous value before action"))
        .addAttribute(new Attribute("_FillValue", ProfileNcConsts.FILL_VALUE_FLOAT));

    Variable.Builder VarHistoryQcTest = builder.addVariable(ProfileNcConsts.HISTORY_QCTEST, DataType.STRING,
            Arrays.asList(nHistoryDim, nProfDim, string16Dim))
